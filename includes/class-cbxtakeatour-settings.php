...
if ( ! class_exists('CBXTakeaTour_Settings')):
    class CBXTakeaTour_Settings
    {
        ...
        function callback_multicheck($args, $value = null)
        {
            ...
            $html = '<p class="grouped gapless grouped_buttons checkbox_fields_check_actions"><a href="#" class="button primary checkbox_fields_check_action_call">'.esc_html__('Check All', 'cbxtakeatour').'</a><a href="#" class="button outline checkbox_fields_check_action_ucall">'.esc_html__('Uncheck All', 'cbxtakeatour').'</a></p>';
