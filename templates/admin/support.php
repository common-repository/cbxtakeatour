...
?>
<div class="wrap cbx-chota cbxtakeatour-page-wrapper cbxtakeatour-support-wrapper" id="cbxtakeatour-support">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2></h2>
                <?php do_action('cbxtakeatour_wpheading_wrap_before', 'support'); ?>
                <div class="wp-heading-wrap">
                    <div class="wp-heading-wrap-left pull-left">
                        <?php do_action('cbxtakeatour_wpheading_wrap_left_before', 'support'); ?>
                        <h1 class="wp-heading-inline wp-heading-inline-cbxtakeatour">
                            <?php esc_html_e('CBX Tours: Support & Docs', 'cbxtakeatour'); ?>
                        </h1>
                        <?php do_action('cbxtakeatour_wpheading_wrap_left_after', 'support'); ?>
                    </div>
                    <div class="wp-heading-wrap-right pull-right">
                        <?php do_action('cbxtakeatour_wpheading_wrap_right_before', 'support'); ?>
                        <a href="<?php echo admin_url('admin.php?page=cbxtakeatour-settings'); ?>"
                           class="button outline primary pull-right"><?php esc_html_e('Global Settings', 'cbxtakeatour'); ?></a>
                        <?php do_action('cbxtakeatour_wpheading_wrap_right_after', 'support'); ?>
                    </div>
                </div>
                <?php do_action('cbxtakeatour_wpheading_wrap_after', 'support'); ?>
            </div>
        </div>
        <div class="row">
            <div class="col-6">
                <div class="cbx-backend-card">
                    <div class="header">
                        <div class="text">
                            <h2><?php esc_html_e('Get Free & Pro Addons', 'cbxtakeatour'); ?></h2>
                        </div>
                    </div>
                    <div class="content">
                        <div class="row">
                                    ...
                                    <div class="feature-card-body static">
                                        <div class="feature-card-header">
                                            <a href="<?php echo esc_url($plugin_url); ?>" target="_blank">
                                                <img src="https://codeboxr.com/wp-content/uploads/productshots/18278-profile.png"
                                        ...
                                        <div class="feature-card-description">
                                            <h3>
                                                <a href="<?php echo esc_url($plugin_url); ?>"
                                                   target="_blank">CBX Tour – User Walkthroughs/Guided Tours Pro
                                                    Addon</a></h3>
                                            <p>Pro features for CBX Tour plugin.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="cbx-backend-card dashboard-changelog">
                    ...
                    <div class="content">
                        ...
                        <div class="cbx-backend-settings-row">
                            ...
                            <ul>
                                <li>[improvement] Minor improvements and bug fixes.</li>
                            </ul>
                        </div>
                        <div class="cbx-backend-settings-row">
                            <p>
                            ...
                            <ul>
                                <li>[improvement] Dashboard ui/ux improvement for the whole Tour plugin's dashboard
                                    area
                                </li>
                                <li>[pro addon] New version of pro addon released that compatible with 1.0.12</li>
                                <li>[new] New color picker</li>
                                <li>[new] New confirm dialog</li>
                            </ul>
                        </div>
                        <div class="cbx-backend-settings-row">
                            <p>
                                Version - 1.0.11 - 14 April, 2023
                            </p>
                            <ul>
                                <li>[improvement] WordPress 6.0 compatibility check & minor improvements</li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="cbx-backend-card dashboard-changelog">
                    ...
                    <div class="content">
                        ...
                        <div class="cbx-backend-settings-row">
                            ...
                            <ul>
                                <li>[improvement] Dashboard ui/ux improvement for the whole Tour plugin's dashboard area</li>
                                <li>[pro addon] New version of pro addon released that compatible with 1.0.12</li>
                                <li>[new] New color picker</li>
                                <li>[new] New confirm dialog</li>
                            </ul>
            ...
            <div class="col-6">
                <div class="cbx-backend-card dashboard-support">
                    <div class="header">
                        <div class="text">
                            <h2><?php esc_html_e('Help & Supports', 'cbxtakeatour'); ?></h2>
                        </div>
                    </div>
                    <div class="content">
                        <div class="cbx-backend-settings-row">
                            <a href="<?php echo esc_url($plugin_url); ?>" target="_blank">
                                ...
                                <?php esc_html_e('CBX Take a Tour Plugin Details', 'cbxtakeatour'); ?> </a>
                        </div>
                        <div class="cbx-backend-settings-row">
                            <a href="<?php echo esc_url($doc_url); ?>" target="_blank">
                                ...
                                <?php esc_html_e('Documentation & User Guide', 'cbxtakeatour'); ?> </a>
                        </div>
                        <div class="cbx-backend-settings-row">
                            <a href="https://wordpress.org/support/plugin/cbxtakeatour/reviews/#new-post" target="_blank">
                                <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <?php esc_html_e('Review & Rate CBX Tour Plugin', 'cbxtakeatour'); ?> </a>
                        </div>
                        <div class="cbx-backend-settings-row">
                            <a href="https://wordpress.org/support/plugin/cbxtakeatour/" target="_blank">
                                ...
                                <?php esc_html_e('Core Plugin Support', 'cbxtakeatour'); ?></a>
                        </div>
                        <div class="cbx-backend-settings-row">
                ...
                <div class="cbx-backend-card dashboard-wp-plugin">
                    <div class="header">
                        <div class="text">
                            <h2><?php esc_html_e('Other WordPress Plugins', 'cbxtakeatour'); ?></h2>
                        </div>
                    </div>
                    <div class="content">
                        <?php
                ...
                <div class="cbx-backend-card dashboard-wp-plugin">
                    <div class="header">
                        <div class="text">
                            <h2><?php esc_html_e('Codeboxr News Updates', 'cbxtakeatour'); ?></h2>
                        </div>
                    </div>
                    <div class="content">
                        <?php
